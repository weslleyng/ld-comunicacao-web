...
export default function TermosPage() {
  return (
    <LegalSection title="Termos de uso">
      ...
      <p>Estes Termos formam um acordo entre você e a LD Comunicação sobre o uso do site. Eles valem em conjunto com a nossa <a href="/privacidade"><strong>Política de Privacidade</strong></a>, que explica como tratamos seus dados pessoais.</p>
      ...
      <p>O tratamento de dados pessoais coletados no site é descrito na nossa <a href="/privacidade"><strong>Política de Privacidade</strong></a>, elaborada conforme a <strong>LGPD (Lei nº 13.709/2018)</strong> e o <strong>Marco Civil da Internet (Lei nº 12.965/2014)</strong>. Recomendamos a leitura para entender quais dados são coletados, como são usados e quais são os seus direitos.</p>
